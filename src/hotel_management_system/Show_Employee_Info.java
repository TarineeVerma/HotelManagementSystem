...
public class Show_Employee_Info extends javax.swing.JFrame {

    Connection con;
    Statement stm;
   
    
    public Show_Employee_Info() {
        initComponents();
        
       
       JLabel  igmL = new JLabel();
       igmL.setBounds(600,30,100,100);
       ...
       table.setFont(new Font("Tw Cen MT", Font.PLAIN, 11));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Show_Employee_Info.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Show_Employee_Info().setVisible(true);
            }
        });
    }
